...
Rules: Use today's real, current market data (web-search enabled). Never use em dashes in the narrative; use commas, colons, parentheses, or periods instead. Include concrete price ranges and percentages as in the example. Be specific to the subject aircraft's make/model/year. Do NOT set or justify the appraised value itself - keep pricing directional and market-descriptive only; the detailed adjustments and final value conclusion are handled in the lower half of the appraisal.`;
