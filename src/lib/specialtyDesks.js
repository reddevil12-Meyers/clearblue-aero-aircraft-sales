...
export const SPECIALTY_DESKS = [
  {
    ...
    meta: "Buyer representation and brokerage for Beechcraft Bonanza, Baron, Duke, and King Air. A specialty desk of ClearBlue Aero.",
    kicker: "Beechcraft Buyers",
    h1: "A Beechcraft desk that works for the buyer — and lists for the owner.",
    deck: "Beechcraft Buyers is a specialty desk of ClearBlue Aero. Same phone, same file, make-specific attention for Bonanza, Baron, Duke, and King Air.",
    what: [
...
export const HUB_CONTENT = {
  ...
  deck:
    "Searchers type a make or an era. They should land on a desk that knows that airframe — and still close through ClearBlue Aero.",
  cards: [
