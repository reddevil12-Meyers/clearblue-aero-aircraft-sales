    ...
    <div className="bg-white w-full">
      ...
      <section className="py-20 bg-[#00447f] text-center px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link to="/public/contact" className="flex items-center gap-2 px-8 py-4 rounded font-bold text-sm hover:brightness-110 transition-all" style={{ backgroundColor: '#FF6B00', color: '#fff' }}>
