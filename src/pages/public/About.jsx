      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-500 leading-relaxed">
              <p>John Secord is the founder and principal of ClearBlue Aero and Avigint, Inc., and principal of Beechcraft Buyers. A proud disabled military veteran with 20+ years of experience in both general aviation and professional airline operations, John also has extensive profas well as the corporate high-tech sector, John brings a balanced approach to managing his businesses . An ATP and Commercial-rated pilot, John has accumulated thousands of hours across a wide range of factory, experimental, and transport-category aircraft, including his last on the B767 & B757. A passionate aircraft owner and active pilot, John combines hands-on enthusiasm for general aviation with the discipline of professional crew operations. His expertise spans aircraft acquisition, brokerage, and consulting, making him a trusted guide for buyers and sellers navigating the aviation private and corporate markets.</p>
