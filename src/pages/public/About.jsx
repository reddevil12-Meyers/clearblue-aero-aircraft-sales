        ...
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-500 leading-relaxed">
              <p>ClearBlue Aero was established by aviation veterans with a passion for connecting pilots with the right aircraft. Based in Florida, we have been serve buyers and sellers across the country, specializing in single-engine, twin-engine, and turboprop aircraft 
