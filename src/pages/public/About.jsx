  ...
  return (
    <div className="bg-white w-full">
      ...
      <div className="bg-[#00447f] py-24 px-4 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-white mb-5" style={{ fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl font-black text-[#00447f] mb-6" style={{ fontFamily: "'Open Sans', sans-serif" }}>
      ...
      <section className="py-20 bg-[#f5f6f8]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-14">
            ...
            <h2 className="text-4xl font-black text-[#00447f]" style={{ fontFamily: "'Open Sans', sans-serif" }}>Our Values</h2>
          </div>
      ...
      <section className="py-20 bg-[#00447f] text-center px-4">
        ...
        <h2 className="text-4xl font-black text-white mb-5" style={{ fontFamily: "'Open Sans', sans-serif" }}>Let's Find Your Aircraft</h2>
