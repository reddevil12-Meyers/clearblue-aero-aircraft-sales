...
function SectionH2({ children }) {
  return <h2 className="text-3xl md:text-4xl font-black text-white mb-6">{children}</h2>;
}
...
export default function EstateAircraft() {
  ...
  return (
    <div className="w-full" style={{ backgroundColor: NAVY }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={s.num} className="rounded-xl p-6 border border-white/10 text-center" style={{ backgroundColor: NAVY }}>
      ...
      {/* 4. Split of labor — two short columns */}
      <section className="px-4 py-20">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div key={d.title} className="rounded-2xl p-7 border border-white/10 flex flex-col" style={{ backgroundColor: NAVY_DARK }}>
          ...
          <p className="text-white/40 text-sm mt-6">Working documents follow intake.</p>
        </div>
      </section>

      {/* 7. Intake */}
      <section id="intake" className="px-4 py-20" style={{ backgroundColor: NAVY_DARK }}>
        <div className="max-w-2xl mx-auto">
          <GoldRule />
          <SectionH2>Send four facts.</SectionH2>
