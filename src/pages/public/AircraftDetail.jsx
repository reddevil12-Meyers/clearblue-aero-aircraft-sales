      ...
      <div className="w-full px-4 pt-6">
        <div className="max-w-5xl mx-auto bg-white overflow-hidden border border-gray-100 shadow-sm rounded-xl">
          <div className="bg-gray-100">
            ...
            {images.length > 0 ? (
              <>
                <img src={images[imgIndex]} alt={altFor(imgIndex)} className="absolute inset-0 w-full h-full object-cover" />
                {images.length > 1 && (
                  <>
            ...
            <div className="flex gap-2 p-3 overflow-x-auto bg-gray-50 justify-center">
              {images.map((url, i) => (
                <button key={i} onClick={() => setImgIndex(i)}
                  ...
                  <img src={url} alt={altFor(i)} loading="lazy" className="w-full h-full object-cover" />
                </button>
              ))}
            </div>
          )}
