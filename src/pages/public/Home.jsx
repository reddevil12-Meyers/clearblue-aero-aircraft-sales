    ...
    <div className="bg-white w-full">
      ...
      <div
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <p className="text-[hsl(var(--background))] mb-10 mx-auto text-base leading-relaxed opacity-100 max-w-2xl">
            <span className="block font-bold mb-3 pt-10 text-[1.5625rem]">Specialized Aviation Sales and Acquisitions</span>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 mb-8">
            ...
            <img src="https://media.base44.com/images/public/69c80400f629e8d863dc8b6c/10fecde10_generated_image.png" alt="Gardner Aircraft Sales" className="h-16 md:h-20 w-auto object-contain" />
          </div>
