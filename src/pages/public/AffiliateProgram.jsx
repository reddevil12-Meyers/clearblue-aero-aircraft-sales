  ...
  return (
    <div className="bg-white w-full">
      ...
      <div className="bg-[#00447f] py-24 px-4 text-center">
        ...
        <p className="text-white/50 text-lg max-w-2xl mx-auto leading-relaxed mb-10">Join the ClearBlue Aero affiliate network and turn your aviation connections into a reliable revenue stream. Refer aircraft owners who want to sell - we handle the brokerage; you collect the commission.
