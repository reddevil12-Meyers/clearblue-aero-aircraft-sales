...
export default function PublicMaintenance() {
  ...
  return (
    <div className="bg-white w-full">
      {/* Hero */}
      <div className="relative bg-[#00447f] py-24 px-4 text-center overflow-hidden">
        <div
          className="absolute inset-0"
          style={{
            backgroundImage: "url('https://media.base44.com/images/public/69c80400f629e8d863dc8b6c/9e38c8d09_IMG_4599.jpeg')",
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/85 text-lg max-w-2xl mx-auto leading-relaxed">ClearBlue Aero brings brokerage-level diligence to maintenance oversight - protecting buyers and sellers through every phase of a transaction.
          </p>
        </div>
      </div>
